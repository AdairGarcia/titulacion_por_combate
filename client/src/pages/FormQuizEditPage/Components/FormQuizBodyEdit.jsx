import editarCuestionario from '../../../assets/EditarCuestionario.png';
...
export const FormQuizBodyEdit = () => {
    const [color, setColor] = useState('#000000');
    const navigate = useNavigate();
    const {id} = useParams();
    const {getForm, form, updateForm} = useForms();
